...
export function Footer() {
  ...
  return (
    <footer className="bg-[#020B14] border-t border-[#1E2A38] pt-10 md:pt-12 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex gap-4">
              {/* Social Icons */}
              <Link href="#" className="text-[#AAB3C2] hover:text-white transition-colors">
        ...
        <div className="pt-8 border-t border-[#1E2A38] flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-[#AAB3C2] text-sm">
            © {new Date().getFullYear()} Kobara. All rights reserved.
          </div>
